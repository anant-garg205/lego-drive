...
import numpy as np
import carla
from navbev.sim.data_collection.agents.navigation.agent import Agent
from navbev.sim.data_collection.agents.navigation.local_planner_behavior import LocalPlanner, RoadOption
from navbev.sim.data_collection.agents.navigation.global_route_planner import GlobalRoutePlanner
from navbev.sim.data_collection.agents.navigation.global_route_planner_dao import GlobalRoutePlannerDAO
from navbev.sim.data_collection.agents.navigation.types_behavior import Cautious, Aggressive, Normal
...
class BehaviorAgent(Agent):
    ...
    def run_step(self, debug=False):
        ...
        # Calculate controller based on no turn, traffic light or vehicle in front
            ...
            control = self._local_planner.run_step(
                target_speed= min(self.behavior.max_speed, self.speed_limit - self.behavior.speed_lim_dist), debug=False)
