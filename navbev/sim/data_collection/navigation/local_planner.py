...
import carla
from navbev.sim.data_collection.agents.navigation.controller import VehiclePIDController
from navbev.sim.data_collection.agents.navigation.misc import draw_waypoints
...
class LocalPlanner(object):
    ...
    def run_step(self, debug=False):
        ...
        if debug:
            ...
            draw_waypoints(self._vehicle.get_world(), self._waypoint_buffer, self._vehicle.get_location().z + 1.0)
