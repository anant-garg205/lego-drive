...
def get_args_parser():
    ...
    parser.add_argument(
        "--metric",
        default="pointing_game",
        type=str,
        choices=["pointing_game", "intersection_at_t", "recall_at_k", "dice_score"],
    )
...
def evaluate(image_encoder, joint_model, val_loader, args):
    ...
    for step, batch in enumerate(val_loader):
        ...
        if args.metric == "pointing_game":
            ...
            accuracy = intersection_at_t(
                output_mask, gt_mask, args.mask_thresh, args.area_thresh
            )
