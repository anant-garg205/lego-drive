...
sys.path.append("/home/rrc/Documents/IROS_24/code/RNR/refer/")
...
class ReferDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # mask = torch.from_numpy(orig_mask).float()
        mask[mask > 0] = 1
        ...
        batch = {
            ...
            "seg_mask": mask,
            "index": idx,
            #'orig_image': resize(np.array(orig_img), (448, 448), anti_aliasing=True),
