...
class Talk2Car(data.Dataset):
    def __init__(
        ...
        root,
        split,
        vocabulary=f"{abs_path}/vocabulary.txt",
        transform=None,
        mask_transform=None,
        glove_path="",
        max_len=30,
        ...
        self.data = {}
        if self.split == "test":
            data_file = "/home/anant.garg/Documents/iros_24/code/GLC/dataloader/talk2car_test.json"
        else:
            data_file = f"{abs_path}/talk2car_w_rpn_no_duplicates.json"
        with open(
            data_file,
            "rb",
        ) as f:
        ...
        self.goal_points = np.load(f"{abs_path}/goalPoints.npy")
    ...
    def __getitem__(self, idx):
        ...
        output["goal_position"] = self.goal_points[idx]
