...
def main(args):
    ...
    joint_model.load_state_dict(
        torch.load(
            "/home/anant.garg/Documents/iros_24/code/GLC/saved_model/talk2car/baseline_drop_0.25_bs_64_el_1_sl_40_bce_0.54858.pth"
        )["state_dict"],
        strict=False,
    )

    ########## Set All parameters grad = False except Goal Prediction Head #########
    for param in joint_model.parameters():
        param.requires_grad = False

    for param in joint_model.goal_prediction.parameters():
    ...
    normalize = transforms.Normalize(
        mean=[0.38907872059321985, 0.3975488809629286, 0.39319937416227135], std=[0.221822932362755, 0.21504570555244915, 0.2176656348677924]
    )
