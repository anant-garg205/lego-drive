...
class JointModel(nn.Module):
    def __init__(
        ...
        self.goal_prediction = GoalPrediction()
    ...
    def forward(self, image, phrase, img_mask, phrase_mask):
        ...
        # print("Fused features shape: ",fused_feature.shape)
        ################################################

        ################## Goal Prediction #################
        goal_2d = self.goal_prediction(fused_feature)
        # print("Goal 2d", goal_2d)
...
class GoalPrediction(nn.Module):
    def __init__(self, in_channels=1536, output_size=2):
